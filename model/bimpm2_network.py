...
class BiMPM(nn.Module):
    def __init__(self, embed_size=32,num_perspective=4,):
        super(BiMPM, self).__init__()

        self.word_dim = embed_size
    ...
    def forward(self, *input):
        ...
        # con_p = self.dropout_layer(con_p)
        # con_h = self.dropout_layer(con_h)
        ...
        # mv_p = self.dropout_layer(mv_p)
        # mv_h = self.dropout_layer(mv_h)
